...
class Source():
    ...
    def __init__(self, m_1, m_2, ecc, dist, n_proc=1, f_orb=None, a=None, position=None, polarisation=None,
        ...
        """
        Parameters:
            m_1 ([type]): [description]
            m_2 ([type]): [description]
            ecc ([type]): [description]
            dist ([type]): [description]
            n_proc (int, optional): [description]. Defaults to 1.
            f_orb ([type], optional): [description]. Defaults to None.
            a ([type], optional): [description]. Defaults to None.
            position ([type], optional): [description]. Defaults to None.
            polarisation ([type], optional): [description]. Defaults to None.
            inclination ([type], optional): [description]. Defaults to None.
            weights ([type], optional): [description]. Defaults to None.
            gw_lum_tol (float, optional): [description]. Defaults to 0.05.
            stat_tol ([type], optional): [description]. Defaults to 1e-2.
            interpolate_g (bool, optional): [description]. Defaults to True.
            interpolate_sc (bool, optional): [description]. Defaults to True.
            sc_params (dict, optional): [description]. Defaults to {}.
        ...
        self.stat_tol = stat_tol # Change in frequency above which a binary should be considered stationary (`float`)
        ...
        self._gw_lum_tol = gw_lum_tol # Allowed error on the GW luminosity when calculating SNRs. (`float`)
        scs.Source.set_g(interpolate_g) # Whether to interpolate the g(n,e) function from Peters (1964). (`boolean`)
    ...
    def get_snr(self, t_obs=None, instrument=None, custom_psd=None, n_step=100,
        ...
        Parameters:
            ...
            instrument (string, optional): Default based on 'LISA' instrument
            custom_psd (function, optional): Function for computing the PSD. Defaults to None.
            n_step (int, optional): [description]. Defaults to 100.
            verbose (bool, optional): Whether to print additional information. Defaults to False.
            re_interpolate_sc (bool, optional): [description]. Defaults to True.
    ...
    def plot_source_variables(self, xstr, ystr=None, which_sources=None,
                              exclude_merged_sources=True, **kwargs):
        """ Plot distributions of Source variables.
        Parameters:
            xstr ([type]): [description]
            ystr ([type], optional): [description]. Defaults to None.
            which_sources ([type], optional): [description]. Defaults to None.
            exclude_merged_sources (bool, optional): [description]. Defaults to True.
        Returns:
            [type]: [description]
        """        
