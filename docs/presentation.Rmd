...
```{r, fig.cap=c("Table 1. Physical properties of the known verification binaries", "Table 2. Measured EM properties and derived GW parameters"), out.width="25%", fig.show='hold'}
